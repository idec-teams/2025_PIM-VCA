  ...
  return (
    <div className="m-h-[100vh] bg-primary">
      <section className="w-full relative">
        <img src="images/home/1.webp" className="w-full" />
      ...
      <section className="w-full relative">
        <img src="images/home/2.webp" className="w-full" />
 ...
 (BL21 and Nissle 1917).</div>
      ...
      <section className="w-full relative aspect-[1920/1076] flex flex-col">
        <div className="relative w-full">
          <img src="images/home/4.webp" className="w-full" />
      ...
      <section className="w-full relative">
        <img src="images/home/5.webp" className="w-full" />
      ...
      <section className="w-full relative">
        <img src="images/home/6.webp" className="w-full" />
      ...
      <section className="w-full relative">
        <img src="images/home/7.webp" className="w-full" />
        <div className="absolute top-[10%] left-[4%] text-white w-[40%] border-white border-solid border-t-[1px] border-b-[1px] py-4 px-2">
        ...
        <div className="absolute bottom-[5%] left-[5%] bg-gray-300/60 w-[90%] h-[40%] flex">
          <div className="flex-1 p-4">
            <div className="text-[#4C1894] text-2xl xl:text-4xl">About Us</div>
          </div>
          <div className="flex-1 p-4">
            <div className="text-[#4C1894] text-2xl xl:text-4xl">Contact Us</div>
          </div>
        </div>
      </section>
    </div>
